...
func log(_ msg: String) { AppLog.shared.append("[ZeroM$] \(msg)") }
...
enum AppUpdateChecker {
    ...
    static let apiURL = URL(string: "https://api.github.com/repos/YangJiiii/ZeroM$/releases/latest")!
    static let fallbackURL = URL(string: "https://github.com/YangJiiii/ZeroM$/releases/latest")!
    ...
    static func check() async -> Offer? {
        ...
        request.setValue("ZeroM$", forHTTPHeaderField: "User-Agent")
